...
public class IphoneRepository implements IIphoneRepository {
    private static final String LIST_ALL_IPHONE = "select sp.id, lsp.ten_loai_san_pham, sp.ten_san_pham, sp.nha_cung_cap,\n" +
    ...
    public List<Iphone> listAll(String iphoneName) {
        ...
        try {
            PreparedStatement preparedStatement = BaseRepository.getConnection().prepareStatement(LIST_ALL_IPHONE);
